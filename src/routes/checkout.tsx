...
import { EMPTY_DRAFT, clearCart, saveCheckoutDraft, setBuyNow, useOguraState } from "@/state/store";
...
function CheckoutPage() {
  ...
  const shipping = subtotal >= 2999 ? 0 : draft.deliveryMethod === "express" ? 249 : 99;
