-- ============================================================================
-- OGURA PRODUCTION DATABASE FOUNDATION (PHASE 1) — CLOUD BOOTSTRAP
-- Source: 20260915000000_ogura_p1_database_foundation.sql (unmodified on disk)
-- Cloud delta: local `auth` schema / `auth.users` compatibility shim omitted;
-- the real Supabase Cloud auth.users is used instead. All other SQL identical.
-- ============================================================================
