...
BEGIN
    ...
    VALUES ('cccc3333-0000-0000-0000-000000000003', '77777777-7777-7777-7777-777777777777', 'Suspended Brand', 'Suspended LLP', 'suspended-brand', 'suspended')
    ...
    VALUES ('faaa0000-0000-0000-0000-000000000001', 'aaaa1111-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000001', 'Active Silk Kurta', 'active-silk-kurta', 'live')
    ON CONFLICT (id) DO UPDATE SET status = 'live';

    -- Live product from suspended seller C
    INSERT INTO products (id, seller_id, brand_id, subcategory_id, title, slug, status)
    VALUES ('fccc0000-0000-0000-0000-000000000003', 'cccc3333-0000-0000-0000-000000000003', 'c1110000-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000001', 'Hidden Kurta', 'hidden-kurta', 'live')
    ON CONFLICT (id) DO UPDATE SET status = 'live';
